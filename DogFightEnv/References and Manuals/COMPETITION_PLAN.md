...
**Read F6 before trusting any v7 stage result.** The E2 carry-forward persists metrics *across
stage boundaries* and the advancement gate does not check `metrics_age_iters`, so v7's stage 1
advanced on stage 0's final episode having closed **zero episodes of its own**.
